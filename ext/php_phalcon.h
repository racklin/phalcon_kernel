...
#define PHP_PHALCON_VERSION "0.5.0b1"
#define PHP_PHALCON_EXTNAME "sample"
...
ZEND_EXTERN_MODULE_GLOBALS(sample)

#ifdef ZTS
	#define PHALCON_GLOBAL(v) TSRMG(sample_globals_id, zend_sample_globals *, v)
#else
	#define PHALCON_GLOBAL(v) (sample_globals.v)
#endif
